...
from src.core.models import IngestResult
from src.ingest.chunking import SemanticChunkingService
from src.ingest.loaders import DocumentLoaderRouter, dump_normalized_documents
...
class IngestionService:
    def __init__(self, settings: Settings, embeddings: object, vector_store: VectorStoreService) -> None:
        ...
        self._chunking = SemanticChunkingService(embeddings)
